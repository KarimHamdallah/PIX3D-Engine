...
namespace PIX3D
{
    namespace VK
    {
        ...
        void VulkanVertexBuffer::FillData(const void* VertexData, size_t Size)
        {
            m_Size = Size;
            ...
            CopyBuffer(Context->m_CommandPool, Context->m_Queue.GetVkQueue(), m_VertexBuffer.m_Buffer, StagingBuffer.m_Buffer, Size);
        ...
        BufferAndMemory VulkanVertexBuffer::CreateBuffer(VkDeviceSize Size,
        ...
        void VulkanVertexBuffer::CopyBuffer(VkCommandPool CmdPool,
            VkQueue Queue,
            VkBuffer DstBuffer,
            VkBuffer SrcBuffer,
            VkDeviceSize Size)
        ...
        uint32_t VulkanVertexBuffer::FindMemoryType(VkPhysicalDevice PhysDevice,
            uint32_t TypeFilter,
            VkMemoryPropertyFlags Properties)
        {
