...
namespace PIX3D
{
    namespace VK
    {
        ...
        void VulkanIndexBuffer::FillData(const void* BufferData, size_t Size)
        {
            m_Size = Size;
            ...
            CopyBuffer(Context->m_CommandPool, Context->m_Queue.GetVkQueue(), m_IndexBuffer.m_Buffer, StagingBuffer.m_Buffer, Size);
        ...
        BufferAndMemory VulkanIndexBuffer::CreateBuffer(VkDeviceSize Size,
        ...
        void VulkanIndexBuffer::CopyBuffer(VkCommandPool CmdPool,
            VkQueue Queue,
            VkBuffer DstBuffer,
            VkBuffer SrcBuffer,
            VkDeviceSize Size)
        ...
        uint32_t VulkanIndexBuffer::FindMemoryType(VkPhysicalDevice PhysDevice,
            uint32_t TypeFilter,
            VkMemoryPropertyFlags Properties)
        {
